# ProperShieldWalls — notes archive

Older `notes.md` entries, moved verbatim. The journal is immutable: entries are ARCHIVED, never rewritten.
...
<!-- archived from notes.md 2026-07-13 -->
